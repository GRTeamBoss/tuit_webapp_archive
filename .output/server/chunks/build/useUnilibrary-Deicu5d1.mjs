...
import { u as useAppConfig, t as tv, g as getSlotChildrenText, c as _sfc_main$f, a as _sfc_main$a } from './server.mjs';
...
const useUnilibrary = async () => {
  ...
  const getBookByName = async (page, name) => {
  ...
  const getBookByAuthor = async (page, author) => {
  ...
  const getPostByName = async (page, name) => {
  ...
  const getPostByAuthor = async (page, author) => {
  ...
  const getDissertations = async (page) => {
  ...
  const getDissertationsByName = async (page, name) => {
  ...
  const getDissertationsByAuthor = async (page, author) => {
...
export { _sfc_main as _, useUnilibrary as u };
//# sourceMappingURL=useUnilibrary-Deicu5d1.mjs.map
