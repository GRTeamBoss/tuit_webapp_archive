...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DsDTPApR.mjs')
  },
  {
    name: "catalog",
    path: "/catalog",
    component: () => import('./index-nVBBNHMe.mjs')
  },
  {
    name: "catalog-unilibrary",
    path: "/catalog/unilibrary",
    component: () => import('./index-r8dHxyne.mjs')
  },
  {
    name: "catalog-unilibrary-slug",
    path: "/catalog/unilibrary/:slug()",
    component: () => import('./_slug_-DwneMMjx.mjs')
  }
];
...
const ipxRuntime$HnC6AEonw_GXQzt6c7dDxo9CyflMnwBo9Apvnzbj1N8 = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$HnC6AEonw_GXQzt6c7dDxo9CyflMnwBo9Apvnzbj1N8, defaults: {} }
  }
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CH6l8uQH.mjs').then((m) => m.default || m))
};
...
const title = "TUIT webapp archive";
const description = "Just";
...
export { _export_sfc as _, _sfc_main$a as a, _sfc_main$b as b, _sfc_main$f as c, useRoute as d, entry_default as default, _sfc_main$9 as e, useLocale as f, getSlotChildrenText as g, usePortal as h, get as i, useFormField as j, useFieldGroup as k, useComponentIcons as l, _sfc_main$c as m, looseToNumber as n, omit as o, pickLinkProps as p, _sfc_main$d as q, useState as r, useNuxtApp as s, tv as t, useAppConfig as u, transformUI as v, __nuxt_component_0$3 as w, isArrayOfArray as x };
