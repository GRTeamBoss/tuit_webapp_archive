...
import { defineComponent, computed, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, createVNode, resolveDynamicComponent, hasInjectionContext, inject, useSlots, ref, createCommentVNode, toDisplayString as toDisplayString$1, toRef, provide, toValue, watch, mergeModels, useModel, createTextVNode, isRef, shallowRef, getCurrentInstance as getCurrentInstance$1, cloneVNode, h, createElementBlock, resolveComponent, onServerPrefetch, useAttrs, useTemplateRef, nextTick, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, Text, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, t as defu, v as defuFn, w as klona, x as isEqual, y as parseQuery, z as hasProtocol, A as joinURL, B as getContext, C as withQuery, D as withTrailingSlash, E as withoutTrailingSlash, F as isScriptProtocol, G as sanitizeStatusCode, m as createError$1, H as withLeadingSlash, I as parseURL, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, M as toRouteMatcher, N as createRouter$1, O as getRequestURL, P as getCookie, Q as getRequestHeader, o as destr, R as createDefu, S as parsePath, T as setCookie, U as deleteCookie, V as encodeParam, W as encodePath, X as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-BEiRSGmA.mjs')
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    name: "catalog___en",
    path: "/catalog",
    component: () => import('./index-ugIusHsh.mjs')
  },
  {
    name: "catalog___ru",
    path: "/ru/catalog",
  ...
  {
    name: "catalog-unilibrary___en",
    path: "/catalog/unilibrary",
    component: () => import('./index-KRURhTiY.mjs')
  },
  {
    name: "catalog-unilibrary___ru",
    path: "/ru/catalog/unilibrary",
    component: () => import('./index-KRURhTiY.mjs')
  },
  {
    name: "catalog-unilibrary___uz",
    path: "/uz/catalog/unilibrary",
    component: () => import('./index-KRURhTiY.mjs')
  },
  {
    name: "catalog-unilibrary-slug___en",
    path: "/catalog/unilibrary/:slug()",
    component: () => import('./_slug_-BUqaphXp.mjs')
  },
  {
    name: "catalog-unilibrary-slug___ru",
    path: "/ru/catalog/unilibrary/:slug()",
    component: () => import('./_slug_-BUqaphXp.mjs')
  },
  {
    name: "catalog-unilibrary-slug___uz",
    path: "/uz/catalog/unilibrary/:slug()",
    component: () => import('./_slug_-BUqaphXp.mjs')
  }
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/C5FNUprt"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/C5FNUprt"}/${locale}/messages.json`));
...
const ipxRuntime$rZWrkBPQkptYMZlbJQ6DBxls3PG5Vt_45NR1w_0xY_r_45Y = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$rZWrkBPQkptYMZlbJQ6DBxls3PG5Vt_45NR1w_0xY_r_45Y, defaults: {} }
  }
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-rTPTna1L.mjs').then((m) => m.default || m))
};
            ...
            return [
              !!props.error?.statusCode || !!slots.statusCode ? (openBlock(), createBlock("p", {
                ...
                renderSlot(_ctx.$slots, "statusCode", {}, () => [
                  createTextVNode(toDisplayString$1(props.error?.statusCode), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              !!props.error?.statusMessage || !!slots.statusMessage ? (openBlock(), createBlock("h1", {
                ...
                renderSlot(_ctx.$slots, "statusMessage", {}, () => [
                  createTextVNode(toDisplayString$1(props.error?.statusMessage), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              props.error?.message && props.error.message !== props.error.statusMessage || !!slots.message ? (openBlock(), createBlock("p", {
                ...
                renderSlot(_ctx.$slots, "message", {}, () => [
                  createTextVNode(toDisplayString$1(props.error?.message), 1)
                ])
              ], 2)) : createCommentVNode("", true),
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UError, mergeProps({
    redirect: "/",
    error: {
      statusCode: 404,
...
export { defineLocale as A, en as B, useI18n as C, _export_sfc as _, _sfc_main$a as a, _sfc_main$b as b, _sfc_main$f as c, useRoute as d, entry_default as default, _sfc_main$9 as e, useNuxtApp as f, getSlotChildrenText as g, useLocale as h, usePortal as i, get as j, useFormField as k, useFieldGroup as l, useComponentIcons as m, _sfc_main$c as n, looseToNumber as o, pickLinkProps as p, omit as q, _sfc_main$d as r, useState as s, tv as t, useAppConfig as u, transformUI as v, isArrayOfArray as w, compare as x, getDisplayValue as y, __nuxt_component_0$3 as z };
